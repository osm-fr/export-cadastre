...
public:
    ...
    void requestPDF(const QString &dept, const QString &cityCode, const QString &cityName);

signals:
    void departmentAvailable();
    void citiesAvailable(const QString &department);
    void cityDownloaded(const QString &code, const QString &name, const QString &bbox, QIODevice *data);
...
private slots:
    ...
    void cityFound(QObject* networkReply);
